...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form>
        <table class="table table-striped table-sm">
          <thead>
            ...
            <tr>
              <th>사업자번호</th>
              <td><input type="text" name="bizNo" value="${user.bizNo}" readonly></td>
            </tr>
            <tr>
              <th>제목</th>
	  ...
	  <div class="input-group">
		  <span class="input-group-btn">
		    <button class="btn btn-secondary register" type="button">등록</button>
	      </span>
	  </div>
	  <script>
	  $(document).ready(function(){
		  $(".register").click(function(e){
			  e.preventDefault();
			  var form = $("form");
			  form.attr("action", "/user/userQnaRegister").attr("method", "post");
			  form.submit();
		  });
	  });
	  </script>
